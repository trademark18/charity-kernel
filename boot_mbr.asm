...
; Embedded data
boot_msg	db	"CpS 230: Team Charity", 13, 10
            db	"Daniel Reed", 13, 10
            db	"Carlos Santana", 13, 10
			db	"Stephen Yurkin", 13, 10, 0
...
continue 	db 10, "Press any key to continue", 13, 10, 0
